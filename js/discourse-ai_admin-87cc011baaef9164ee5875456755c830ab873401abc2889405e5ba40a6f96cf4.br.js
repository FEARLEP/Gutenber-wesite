...
e.default=s.default.extend({queryParams:{llmTemplate:{refreshModel:!0}},async model(){const e=this.store.createRecord("ai-llm")
return e.provider_params={},e},setupController(e,s){this._super(e,s),e.set("allLlms",this.modelFor("adminPlugins.show.discourse-ai-llms")),e.set("llmTemplate",this.paramsFor(this.routeName).llmTemplate||null)}})})),define("discourse/plugins/discourse-ai/discourse/routes/admin-plugins-show-discourse-ai-llms-show",["exports","discourse/routes/discourse"],(function(e,s){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
e.default=s.default.extend({async model(e){const s=this.modelFor("adminPlugins.show.discourse-ai-llms"),o=parseInt(e.id,10),i=s.findBy("id",o)
return i.provider_params=i.provider_params||{},i},setupController(e,s){this._super(e,s),e.set("allLlms",this.modelFor("adminPlugins.show.discourse-ai-llms"))}})})),define("discourse/plugins/discourse-ai/discourse/routes/admin-plugins-show-discourse-ai-llms",["exports","discourse/routes/discourse"],(function(e,s){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
return e.set("allowed_group_ids",[s.AUTO_GROUPS.trust_level_0.id]),e.set("rag_uploads",[]),e.set("rag_chunk_tokens",374),e.set("rag_chunk_overlap_tokens",10),e.set("rag_conversation_chunks",10),e.set("allow_personal_messages",!0),e.set("tool_details",!1),e},setupController(e,s){this._super(e,s),e.set("allPersonas",this.modelFor("adminPlugins.show.discourse-ai-personas"))}})})),define("discourse/plugins/discourse-ai/discourse/routes/admin-plugins-show-discourse-ai-personas-show",["exports","discourse/routes/discourse"],(function(e,s){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
//# sourceMappingURL=discourse-ai_admin-9220717bf628d4703f94bba5f1e41e15dfa7a24f27f6632ce04372aab5f39101.map
//!
