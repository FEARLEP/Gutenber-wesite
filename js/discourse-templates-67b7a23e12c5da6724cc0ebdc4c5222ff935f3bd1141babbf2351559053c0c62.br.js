...
if(!this.#C(t))return
const s=document.querySelector(".d-modal"),o=this.#j.bind(this),i=t=>e?.(t)
...
return s&&o?.contains(e)}get isTextAreaFocused(){return this.#C(document.activeElement)}#C(e){return"TEXTAREA"===e?.nodeName}#I(e,t){this.appEvents.trigger("discourse-templates:hijack-modal",{textarea:e,onInsertTemplate:t})}#k(e,t){this.dTemplatesModal.show({textarea:e,onInsertTemplate:t})}#E(e){this.appEvents.trigger("composer-messages:close"),this.appEvents.trigger("composer:show-preview"),this.appEvents.trigger("discourse-templates:show",{onInsertTemplate:e})}#j(e,s,i){s=this.#O(s.title,s.content,i),new o.default((0,t.getOwner)(this),{textarea:e}).insertBlock(s.content)}#M(e){const s=(0,t.getOwner)(this).lookup("controller:composer").model,o=(0,a.default)(s)
...
//# sourceMappingURL=discourse-templates-dabc1545035d384b5c4b1d7aca51d49a423a5a7591f29c51d9171abe0984d0fb.map
//!
